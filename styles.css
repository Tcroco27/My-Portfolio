/* ============================================
   TAREK EL JARAB — PORTFOLIO
   Dark Cinematic AAA Aesthetic
   ============================================ */
...
.ld-logo.visible { opacity: 1; transform: scale(1); }
...
.about-img-wrap:hover .about-img-border { transform: translate(-4px, -4px); }
...
.skill-level.expert { color: var(--accent); }
.skill-level.mid    { color: #7ab0c8; }
.skill-level.low    { color: var(--text-dim); }
...
.skill-fill {
  ...
  animation: barFill 1.2s cubic-bezier(0.16,1,0.3,1) 0.3s both;
}
...
@media (max-width: 900px) {
  ...
  .about-img { max-width: 220px; aspect-ratio: unset; height: 280px; object-fit: cover; }
  .stack-grid { grid-template-columns: 1fr; }
  .featured-card { grid-template-columns: 1fr; }
  .projects-grid { grid-template-columns: 1fr 1fr; }
  .other-card { grid-template-columns: 1fr; }
